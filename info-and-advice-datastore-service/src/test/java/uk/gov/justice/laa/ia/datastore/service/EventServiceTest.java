...
class EventServiceTest {
  ...
  void shouldSaveEventWithCorrectFields() {
    ...
    when(userContext.getProviderOfficeId()).thenReturn("00000000-0000-0000-0000-000000000001");
    ...
    assertThat(saved.getProviderOfficeId()).isEqualTo("00000000-0000-0000-0000-000000000001");
